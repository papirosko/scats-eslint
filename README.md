...
- `scats/no-array-typed-variable`: disallows local variables and class fields typed as `Array<T>`, `ReadonlyArray<T>`, or `T[]`; this catches cases where `.toArray` results are stored explicitly as JavaScript arrays
