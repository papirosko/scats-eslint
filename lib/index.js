...
const noCollectionGetZeroRule = require('./rules/no-collection-get-zero');
const noNullishSyntaxRule = require('./rules/no-nullish-syntax');
const noOptionNullishFallbackRule = require('./rules/no-option-nullish-fallback');
const noOptionForeachAssignmentRule = require('./rules/no-option-foreach-assignment');
const preferGetOrElseValueRule = require('./rules/prefer-get-or-else-value');
...
const rules = {
  ...
  'no-collection-get-zero': noCollectionGetZeroRule,
  'no-nullish-syntax': noNullishSyntaxRule,
  'no-option-nullish-fallback': noOptionNullishFallbackRule,
  'no-option-foreach-assignment': noOptionForeachAssignmentRule,
  'prefer-get-or-else-value': preferGetOrElseValueRule,
...
const recommended = {
  ...
  rules: {
    ...
    'scats/no-collection-get-zero': 'error',
    'scats/no-explicit-empty': 'error',
    'scats/no-option-nullish-fallback': 'error',
    'scats/no-option-foreach-assignment': 'error',
    'scats/prefer-get-or-else-value': 'error',
